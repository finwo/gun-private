...
},{"buffer":2,"ws":11}],4:[function(require,module,exports){
(function (global){
...
},{"buffer":2,"is-buffer":7}],9:[function(require,module,exports){
(function (Buffer){
"use strict";
...
(function (factory) {
  ...
  require['rc4-crypt'] = function () {
    let module = {},
        exports = undefined; // Basic RC4 implementation, I forgot where the code originally was based on
    // If you recognize it, please let me know so I can credit the right person
    ...
    function toByteArray(subject) {
      ...
      if (Array.isArray(subject)) return subject;
      if (isBuffer(subject)) return [...subject];
      if ('string' !== typeof subject) return null; // Hex strings

      if (subject.match(/^([0-9a-f]{2})*$/i)) {
        return subject.match(/[0-9a-f]{2}/ig).map(c => parseInt(c, 16));
      } // Use the string as bytes
  ...
  require['ws-transform'] = function () {
    ...
    module.exports = function (remote, {
      ...
      const local = Object.create(remote); // Intercept egress
  ...
  if ('object' === typeof module) {
    module.exports = factory(require('rc4-crypt'), require('cws'), require('ws-transform'));
    return;
  } // Plain old browser usage


  window.WSRC4 = window.WSRC4 || factory(require('rc4-crypt'), require('cws'), require('ws-transform'));
})(function (rc4, WS, transform) {
  return null || function (key) {
    ...
    sws.Server = function (...args) {
      let server = new WS.Server(...args),
          local = Object.create(server); // Intercept event registering
    ...
    sws.Client = sws; // Return the encrypted socket lib
...
},{"buffer":2,"cws":3,"is-buffer":6,"rc4-crypt":8,"ws":11,"ws-transform":10}],10:[function(require,module,exports){
(function (Buffer){
const direct = d => d;
